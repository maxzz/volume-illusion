...
function LightSwitcher({source, setSource}: {source: number, setSource: (n: number) => void}) {
    return (
        <div className="grid grid-cols-3 text-gray-100">
            <button className="col-span-2 min-w-[64px] focus:outline-none">
                <svg
                    className={`${source === 0 ? 'fill-[#fefe1f] stroke-[#654900]' : 'opacity-30'} h-6 w-6 transform rotate-[135deg] translate-x-[100%]`}
            ...
            <button className=" min-w-[64px] focus:outline-none">
                <svg
            ...
            <button className="col-span-2 min-w-[64px] focus:outline-none">
                <svg
                    className={`${source === 2 ? 'fill-[#fefe1f] stroke-[#654900]' : 'opacity-30'} h-6 w-6 transform rotate-[45deg] translate-x-[100%]`}
                    fill="none" viewBox="0 0 24 24" stroke="currentColor"
                    onClick={() => setSource(2)}
                >
                    <path
